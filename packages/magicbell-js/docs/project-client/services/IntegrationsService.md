...
(async () => {
  ...
  const slackConfigPayload: SlackConfigPayload = {
    appId: 'C8K7S',
    clientId: '668795086.6340373',
    clientSecret: 'magna consectetur ut officiaveni',
    signingSecret: 'ullamcodolornostrud laborum cill',
  };
