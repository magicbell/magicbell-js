...
(async () => {
  ...
  const slackConfigPayload: SlackConfigPayload = {
    appId: 'QLH14P',
    clientId: '353277970.752254347',
    clientSecret: 'ea fugiat consecteturelit sintci',
    signingSecret: 'aute nostrud nisi dolorelaboris ',
  };
