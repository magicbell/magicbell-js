...
/**
 * Zod schema for the FcmConfigPayload model.
...
/**
 * Zod schema for mapping API responses to the FcmConfigPayload application shape.
...
/**
 * Zod schema for mapping the FcmConfigPayload application shape to API requests.
